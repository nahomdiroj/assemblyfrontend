    ...
    const handleRowClick = async (person) => {
      ...
      const handleAttendanceChange = async (id) => {
        try {
            ...
            const isConfirmed = window.confirm(`Are you sure you want unattande ${shareholder.nameeng}?`);
            if (!isConfirmed) return; // Exit if canceled
        ...
        <div className="flex flex-col items-center  min-h-screen bg-gray-100">
            ...
            {result && (
                ...
                <input 
                    ...
                    onChange={shareholder.attendance === 1?() => handleAttendanceChange(shareholder.id):shareholder.votingsubscription>0 &&shareholder.sharesubsription>0 ?() => handleRowClick(shareholder):""} // Toggle attendance
                />
            </td>
